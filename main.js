...
// =====================================
const HERO_IMAGES = [
  "https://res.cloudinary.com/doqzgozyt/image/upload/v1758520871/Shampoo_oxj12p.png?q=80&w=1600&auto=format&fit=crop",
...
const PRODUCT_LIST = [
  ...
  { name: "Susu Kambing NGM", desc: "Susu kambing etawa dengan gula aren, sehat dan nikmat.", img: "https://res.cloudinary.com/doqzgozyt/image/upload/v1758633751/Gemini_Generated_Image_no58b3no58b3no58_gnueme.png" },
...
const GALLERY_IMAGES_2 = [
  "https://res.cloudinary.com/doqzgozyt/image/upload/v1758509657/cld-sample-4.jpg",
  "https://res.cloudinary.com/doqzgozyt/image/upload/v1758509657/cld-sample-2.jpg",
  "https://res.cloudinary.com/doqzgozyt/image/upload/v1758509657/cld-sample.jpg",
  "https://res.cloudinary.com/doqzgozyt/image/upload/v1758509762/Gemini_Generated_Image_b1c719b1c719b1c7_om3vqm.png",
];
const ALL_PRODUCTS = [
  { code: "NOS-003", name: "Natura Oil Squa", category: "Herbal Care", short: "Minyak squalene alami untuk kulit dan sendi.", img: "https://source.unsplash.com/random/1200x1200/?squalene,oil", imgs: ["https://source.unsplash.com/random/1600x1600/?squalene,oil"], priceAgent: 150000, priceConsumer: 175000, points: 20, longDesc: { manfaat: `<p>Dukung kesehatan kulit dan sendi dari dalam. Membantu menjaga kelembaban kulit, serta meredakan nyeri dan peradangan pada sendi.</p>`, komposisi: `<p>Terbuat dari squalene alami yang diekstrak dari minyak zaitun. Kaya akan antioksidan dan vitamin E.</p>`, penyajian: `<p>Untuk konsumsi: Minum 2-3 tetes setiap hari atau sesuai anjuran. Untuk pemakaian luar: Oleskan secukupnya pada area kulit atau sendi yang membutuhkan.</p>` } },
  { code: "SHC-012", name: "Natura Shark Cartilage", category: "Herbal Care", short: "Suplemen tulang rawan hiu untuk kesehatan sendi.", img: "https://source.unsplash.com/random/1200x1200/?shark,cartilage", imgs: ["https://source.unsplash.com/random/1600x1600/?shark,cartilage"], priceAgent: 150000, priceConsumer: 175000, points: 50, longDesc: { manfaat: `<p>Membantu menjaga kesehatan persendian dan tulang rawan. Mengandung nutrisi alami untuk mengurangi peradangan dan nyeri sendi.</p>`, komposisi: `<p>Ekstrak tulang rawan hiu murni yang kaya akan kondroitin dan glukosamin. Kapsul herbal yang mudah dicerna.</p>`, penyajian: `<p>Minum 2 kapsul setiap hari setelah makan, atau sesuai anjuran profesional kesehatan.</p>` } },
  { code: "GMK-013", name: "Gamin Gathuk", category: "Herbal Care", short: "Ramuan herbal untuk stamina pria.", img: "https://source.unsplash.com/random/1200x1200/?herbal,man", imgs: ["https://source.unsplash.com/random/1600x1600/?herbal,man"], priceAgent: 100000, priceConsumer: 125000, points: 25, longDesc: { manfaat: `<p>Membantu meningkatkan stamina, vitalitas, dan energi bagi pria dewasa. Terbuat dari bahan-bahan alami tanpa efek samping.</p>`, komposisi: `<p>Ramuan tradisional dari ekstrak pasak bumi, purwaceng, dan bahan herbal pilihan lainnya.</p>`, penyajian: `<p>Minum 1 kapsul setiap hari, atau 2 kapsul 1-2 jam sebelum beraktivitas. Ikuti petunjuk pada kemasan.</p>` } },
  { code: "SKA-014", name: "Sari Kurma Angkak", category: "Herbal Care", short: "Sari kurma dengan angkak, penambah trombosit.", img: "https://source.unsplash.com/random/1200x1200/?date,extract", imgs: ["https://source.unsplash.com/random/1600x1600/?date,extract"], priceAgent: 45000, priceConsumer: 55000, points: 10, longDesc: { manfaat: `<p>Sari kurma yang diperkaya angkak, efektif untuk meningkatkan trombosit. Cocok dikonsumsi saat masa pemulihan demam berdarah atau setelah sakit.</p>`, komposisi: `<p>Sari kurma alami dan ekstrak angkak, diolah secara higienis tanpa tambahan bahan pengawet.</p>`, penyajian: `<p>Minum 2 sendok makan, 2-3 kali sehari. Bisa diminum langsung atau dicampur dengan air hangat.</p>` } },
  { code: "MBM-016", name: "Minyak Bidara Mumtas", category: "Herbal Care", short: "Minyak multifungsi dengan ekstrak bidara.", img: "https://source.unsplash.com/random/1200x1200/?bidara,oil", imgs: ["https://source.unsplash.com/random/1600x1600/?bidara,oil"], priceAgent: 30000, priceConsumer: 35000, points: 5, longDesc: { manfaat: `<p>Minyak multifungsi dengan aroma bidara yang menenangkan. Biasa digunakan untuk relaksasi dan pijat. Juga dipercaya memiliki manfaat spiritual.</p>`, komposisi: `<p>Minyak kelapa, ekstrak daun bidara, dan minyak esensial lainnya.</p>`, penyajian: `<p>Oleskan secukupnya pada telapak tangan dan pijat perlahan ke seluruh tubuh atau area yang membutuhkan.</p>` } },
  { code: "MTM-018", name: "Minyak Telon Mumtas", category: "Herbal Care", short: "Minyak telon keluarga.", img: "https://source.unsplash.com/random/1200x1200/?telon,oil", imgs: ["https://source.unsplash.com/random/1600x1600/?telon,oil"], priceAgent: 25000, priceConsumer: 30000, points: 5, longDesc: { manfaat: `<p>Memberikan rasa hangat yang nyaman pada tubuh bayi dan seluruh keluarga. Meredakan kembung dan mencegah gigitan nyamuk.</p>`, komposisi: `<p>Terbuat dari campuran minyak kayu putih, minyak adas, dan minyak kelapa alami.</p>`, penyajian: `<p>Oleskan secukupnya pada dada, perut, punggung, atau telapak kaki setelah mandi. Hindari area mata.</p>` } },
  { code: "MMM-019", name: "Madu Multiflora Mumtas", category: "Herbal Care", short: "Madu murni dari berbagai nektar bunga.", img: "https://source.unsplash.com/random/1200x1200/?honey", imgs: ["https://source.unsplash.com/random/1600x1600/?honey"], priceAgent: 90000, priceConsumer: 110000, points: 20, longDesc: { manfaat: `<p>Madu murni multiflora dengan rasa manis alami. Kaya akan vitamin dan mineral untuk menjaga daya tahan tubuh dan meningkatkan energi.</p>`, komposisi: `<p>Madu murni dari nektar berbagai jenis bunga, diproses secara alami tanpa pemanasan berlebihan.</p>`, penyajian: `<p>Minum 1-2 sendok makan setiap hari, bisa dicampur dengan air hangat atau dikonsumsi langsung.</p>` } },
  { code: "ANR-021", name: "Antirac", category: "Herbal Care", short: "Suplemen herbal untuk membantu masalah lambung.", img: "https://source.unsplash.com/random/1200x1200/?herbal,stomach", imgs: ["https://source.unsplash.com/random/1600x1600/?herbal,stomach"], priceAgent: 150000, priceConsumer: 175000, points: 30, longDesc: { manfaat: `<p>Membantu meredakan gejala asam lambung, maag, dan gangguan pencernaan lainnya. Bekerja efektif untuk menenangkan lambung yang iritasi.</p>`, komposisi: `<p>Terbuat dari ekstrak herbal alami seperti kunyit, temulawak, dan jahe yang dipercaya baik untuk kesehatan lambung.</p>`, penyajian: `<p>Minum 2 kapsul, 3 kali sehari setelah makan. Ikuti petunjuk penggunaan yang tertera pada kemasan.</p>` } },
  { code: "SJD-022", name: "SJ-2", category: "Herbal Care", short: "Suplemen herbal untuk kesehatan hati.", img: "https://source.unsplash.com/random/1200x1200/?herbal,liver", imgs: ["https://source.unsplash.com/random/1600x1600/?herbal,liver"], priceAgent: 150000, priceConsumer: 175000, points: 30, longDesc: { manfaat: `<p>Membantu menjaga fungsi hati dan mendetoksifikasi tubuh. Efektif untuk menjaga kesehatan organ vital dan meningkatkan metabolisme.</p>`, komposisi: `<p>Kombinasi ekstrak herbal tradisional seperti sambiloto, meniran, dan temulawak yang sudah teruji khasiatnya.</p>`, penyajian: `<p>Minum 2 kapsul, 3 kali sehari setelah makan. Dianjurkan konsultasi dengan profesional kesehatan sebelum konsumsi.</p>` } },
  { code: "EBM-023", name: "Elbuma", category: "Herbal Care", short: "Suplemen herbal dari ekstrak cacing.", img: "https://source.unsplash.com/random/1200x1200/?cacing,extract", imgs: ["https://source.unsplash.com/random/1600x1600/?cacing,extract"], priceAgent: 75000, priceConsumer: 100000, points: 20, longDesc: { manfaat: `<p>Membantu mengatasi demam dan tifus, serta melancarkan sirkulasi darah. Efektif sebagai terapi pendukung untuk berbagai penyakit.</p>`, komposisi: `<p>Ekstrak cacing Lumbricus rubellus yang kaya protein dan nutrisi penting untuk pemulihan tubuh.</p>`, penyajian: `<p>Minum 2 kapsul, 3 kali sehari. Untuk anak-anak, sesuaikan dosis atau konsultasi dengan profesional.</p>` } },
  { code: "RSO-024", name: "Rosso", category: "Herbal Care", short: "Ramuan herbal untuk melancarkan sirkulasi darah.", img: "https://res.cloudinary.com/doqzgozyt/image/upload/v1758617027/Gemini_Generated_Image_jpwil4jpwil4jpwi_ne8on4.png?q=80&w=1600&auto=format&fit-crop", imgs: ["https://res.cloudinary.com/doqzgozyt/image/upload/v1758617027/Gemini_Generated_Image_jpwil4jpwil4jpwi_ne8on4.png?q=80&w=1600&auto=format&fit-crop"], priceAgent: 100000, priceConsumer: 125000, points: 25, longDesc: { manfaat: `<p>Membantu melancarkan sirkulasi darah dan menjaga kesehatan jantung. Mengurangi risiko stroke dan tekanan darah tinggi.</p>`, komposisi: `<p>Ramuan dari bahan alami seperti bawang putih, jahe, dan ekstrak daun dewa yang berkhasiat.</p>`, penyajian: `<p>Minum 2 kapsul, 2 kali sehari setelah makan. Tidak disarankan untuk penderita hipotensi.</p>` } },
...
// Utilitas
const goldGradient = "bg-gradient-to-r from-[#FFD700] via-[#FFC837] to-[#FFB300]";
...
document.addEventListener('DOMContentLoaded', () => {
  // Inisialisasi semua komponen dinamis
  initNavbar();
  initHero();
  initProdukUnggulan();
  initGallery();
...
// 3. Logika Produk Unggulan (Carousel 3D)
function initProdukUnggulan() {
        ...
        item.innerHTML = `
            <div class="relative rounded-2xl p-[2px]">
                <div class="gradient-border absolute inset-0 rounded-2xl pointer-events-none overflow-hidden" style="opacity: 0;">
                    <div class="absolute -inset-[40%] rounded-full" style="background: conic-gradient(#FFD700,#FFC837,#FFB300,#FFD700); animation: spinGradient 6s linear infinite;"></div>
                </div>
                <div class="card-content w-72 md:w-[32rem] rounded-2xl overflow-hidden bg-gradient-to-br from-black to-gray-900 border border-[#FFC837]/70 shadow-2xl relative transition-transform duration-500">
                    <img src="${p.img}" alt="${p.name}" class="w-full aspect-square object-cover" />
                    <div class="p-6">
                        <h3 class="text-xl font-semibold ${goldText}">${p.name}</h3>
                        <p class="text-sm text-gray-400 mt-1">${p.desc}</p>
                        <button class="mt-4 inline-flex items-center gap-2 rounded-xl px-5 py-2 ${goldGradient} text-black text-sm ${buttonHover}">
    ...
    const updateCarousel = () => {
        ...
        const baseTranslate = isMobile ? 100 : 150; // Jarak pergeseran lebih kecil di HP
        const baseRotate = isMobile ? -20 : -16;    // Rotasi sedikit lebih besar di HP
        const baseScale = isMobile ? 0.6 : 0.65;    // Skala dasar sedikit lebih kecil di HP
        const activeScale = isMobile ? 1.05 : 1.06; // Skala kartu aktif
    ...
    // Panggil updateCarousel saat resize layar untuk penyesuaian
    ...
    updateCarousel(); // Inisialisasi awal
}
...
function initGallery() {
    ...
    // Duplikasi untuk efek marquee tak terputus
    row1.innerHTML = imagesHtml1 + imagesHtml1;
    row2.innerHTML = imagesHtml2 + imagesHtml2;

    row1.style.width = `${GALLERY_IMAGES.length * 2 * 19}rem`; // 18rem width + 1rem gap
    row2.style.width = `${GALLERY_IMAGES_2.length * 2 * 19}rem`;
}

// 5. Logika Semua Produk (Accordion & Modal)
            ...
            <button data-category="${cat}" class="w-full category-toggle">
                <div class="flex items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        <span class="text-lg md:text-xl font-semibold ${goldText}">${cat}</span>
                        <span class="text-xs text-gray-400">${items.length} produk</span>
                    </div>
                    <i data-lucide="plus" class="accordion-icon text-[#FFC837] transition-transform duration-300 flex-shrink-0"></i>
                </div>
                <div class="mt-2 border-b border-[#FFC837]/50"></div>
            </button>
                        ...
                        <div style="perspective: 1500px">
                            <button data-product-code="${p.code}" class="product-card relative rounded-2xl overflow-hidden w-full" style="transform-style: preserve-3d;">
                                ...
                                <div class="absolute inset-0 bg-gradient-to-t from-black/85 via-black/45 to-transparent p-3 flex flex-col justify-end items-start text-left">
                                    ...
                                    <p class="text-xs text-gray-300 mt-1">${p.short}</p>
                                    <div class="mt-2 grid grid-cols-3 items-end gap-2 text-sm w-full">
                                        <div><div class="text-[10px] text-gray-400">Konsumen</div><div class="text-white font-semibold">Rp ${fmt(p.priceConsumer)}</div></div>
                                        <div><div class="text-[10px] text-gray-400">Harga Agen</div><div class="text-[#FFC837] font-semibold">Rp ${fmt(p.priceAgent)}</div></div>
                                        <div class="justify-self-end text-right"><div class="text-[10px] text-gray-400">Poin</div><div class="text-white font-semibold">${p.points}</div></div>
                                    </div>
                                </div>
                            </button>
                        </div>
                    `).join('')}
                    ${items.length === 0 ? `<div class="text-sm text-gray-400 italic">Belum ada produk pada kategori ini.</div>` : ''}
                </div>
            </div>
        </div>
        `;
...
function initLangkahSukses() {
    ...
    grid.innerHTML = LANGKAH_SUKSES.map((s, i) => `
        <div data-animate style="transition-delay: ${i*0.1}s" class="relative h-full">
          <div class="p-[2px] rounded-2xl bg-gradient-to-r from-[#FFC837] via-[#FFC837]/40 to-transparent h-full">
            <div class="relative rounded-[14px] bg-[#121212] border border-white/5 p-5 h-full min-h-[180px] md:min-h-[208px] overflow-hidden flex flex-col justify-end">
              <div class="absolute -top-6 -right-4 select-none font-extrabold leading-none tracking-tight text-white/5" style="font-size: 8rem;">${i + 1}</div>
              <div class="pointer-events-none absolute inset-0 bg-gradient-to-r from-black/0 via-black/0 to-black/30"></div>
              <div class="relative text-left">
                <h4 class="text-lg md:text-xl font-semibold ${goldText}">${s.t}</h4>
                <p class="text-sm text-gray-300 mt-2 leading-relaxed">${s.d}</p>
              </div>
            </div>
          </div>
        </div>
...
function initEvents() {
    ...
    grid.innerHTML = EVENTS.map((ev, i) => `
        <div style="perspective: 800px;" data-animate>
            <button data-event-index="${i}" class="event-card bg-black/50 border border-[#FFC837]/40 rounded-xl overflow-hidden text-left w-full h-full" style="transform-style: preserve-3d;">
                <img src="${ev.img}" alt="${ev.title}" class="w-full aspect-square object-cover" />
                <div class="p-4">
                    <div class="flex items-center gap-2 text-xs mb-2">
                        <span class="px-2 py-0.5 rounded ${ev.type === 'Online' ? 'bg-emerald-600/20 text-emerald-300' : 'bg-sky-600/20 text-sky-300'}">${ev.type}</span>
                        <span class="text-gray-400">${ev.location}</span>
                    </div>
                    <h3 class="text-lg font-semibold text-[#FFC837]">${ev.title}</h3>
    ...
    grid.querySelectorAll('.event-card').forEach(card => {
        card.addEventListener('click', () => {
            const event = EVENTS[card.dataset.eventIndex]; 
            openEventModal(event);
        });

        // Efek 3D mengikuti kursor
        card.addEventListener('mousemove', (e) => {
            const r = card.getBoundingClientRect();
            const px = (e.clientX - r.left) / r.width;
            const py = (e.clientY - r.top) / r.height;
    ...
    container.innerHTML = FAQ_ITEMS.map((item, index) => `
        <div class="faq-item border-b border-white/10">
            <button data-index="${index}" class="faq-toggle w-full text-left py-4 flex items-center justify-between gap-4">
                <span class="text-base font-medium ${goldText}">${item.q}</span>
                <i data-lucide="plus" class="accordion-icon text-[#FFC837] transition-transform duration-300 flex-shrink-0"></i>
            </button>
            <div class="accordion-panel">
                <div class="pb-4 text-gray-300 text-sm leading-relaxed text-left">${item.a}</div>
            </div>
        </div>
        `).join('');
    createIconsSafe();
...
function openProductModal(product) {
    ...
    modal.className = 'fixed inset-0 z-[80] bg-black/70 backdrop-blur-sm grid place-items-center p-4 transition-opacity duration-300';
    
    let currentImgIdx = 0;

    const renderModalContent = () => {
      modal.innerHTML = `
        <div class="modal-content relative w-full max-w-4xl flex flex-col md:flex-row rounded-2xl bg-[#141414] max-h-[90vh] overflow-y-auto md:overflow-hidden transition-transform transform scale-95 duration-300">
            <button class="close-modal absolute top-3 right-3 text-[#FFC837] hover:text-white z-20 p-1 bg-black/50 rounded-full"><i data-lucide="x"></i></button>
            <div class="relative w-full md:w-1/2 flex-shrink-0">
                ...
                <a href="${product.imgs[currentImgIdx]}" download="${product.name.replace(/\s+/g, '-')}-${currentImgIdx + 1}.jpg" class="absolute top-3 left-3 z-10 p-1.5 bg-black/50 rounded-full text-white hover:bg-black/80 transition-opacity" title="Unduh gambar">
                    <i data-lucide="download" class="w-5 h-5"></i>
                </a>
                ${product.imgs.length > 1 ? `
                    <button class="prev-img absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 p-1 rounded-full text-white hover:bg-black/80 transition"><i data-lucide="chevron-left"></i></button>
                    <button class="next-img absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 p-1 rounded-full text-white hover:bg-black/80 transition"><i data-lucide="chevron-right"></i></button>
                ` : ''}
            </div>
            <div class="w-full md:w-1/2 p-6 text-left md:overflow-y-auto">
                <div class="space-y-4">
                    <h3 class="text-2xl font-bold ${goldText}">${product.name}</h3>
                    <p class="text-gray-300 text-sm">${product.short}</p>
                    <div class="grid grid-cols-3 gap-4 text-center border-y border-white/10 py-3">
                        <div><div class="text-[11px] text-gray-400">Harga Konsumen</div><div class="text-white font-semibold">Rp ${fmt(product.priceConsumer)}</div></div>
                        <div><div class="text-[11px] text-gray-400">Harga Agen</div><div class="text-[#FFC837] font-semibold">Rp ${fmt(product.priceAgent)}</div></div>
                        <div><div class="text-[11px] text-gray-400">Poin</div><div class="text-white font-semibold">${product.points}</div></div>
                    </div>
                    <div>
                        <h4 class="font-semibold text-[#FFC837]">Manfaat</h4>
                        <div class="text-gray-400 text-sm mt-1">${product.longDesc.manfaat}</div>
                    </div>
                    <div>
                        <h4 class="font-semibold text-[#FFC837]">Komposisi</h4>
                        <div class="text-gray-400 text-sm mt-1">${product.longDesc.komposisi}</div>
                    </div>
                    <div>
                        <h4 class="font-semibold text-[#FFC837]">Saran Penyajian</h4>
                        <div class="text-gray-400 text-sm mt-1">${product.longDesc.penyajian}</div>
                    </div>
                </div>
            </div>
        </div>`;
...
function openEventModal(event) {
    ...
    modal.className = 'fixed inset-0 z-[80] bg-black/70 backdrop-blur-sm grid place-items-center p-4 transition-opacity duration-300';
    modal.innerHTML = `
        <div class="modal-content relative w-full max-w-2xl rounded-2xl bg-[#141414] max-h-[90vh] overflow-y-auto transition-transform transform scale-95 duration-300">
            <button class="close-modal absolute top-2 right-2 text-[#FFC837] hover:text-white">✕</button>
            <img src="${event.img}" alt="${event.title}" class="w-full object-cover aspect-square" />
            <div class="p-6 text-left space-y-3">
                <div class="flex items-center gap-2 text-xs">
                    <span class="px-2 py-0.5 rounded ${event.type === 'Online' ? 'bg-emerald-600/20 text-emerald-300' : 'bg-sky-600/20 text-sky-300'}">${event.type}</span>
                    <span class="text-gray-400">${event.location}</span>
                </div>
                <h3 class="text-2xl font-bold ${goldText}">${event.title}</h3>
                <p class="text-gray-300 text-sm">${event.desc}</p>
                <div class="text-gray-400 text-sm">${event.details}</div>
                <a href="${event.img}" download class="mt-4 inline-flex items-center gap-2 rounded-xl px-3 py-1.5 ${goldGradient} text-black text-sm ${buttonHover}">
...
// 12. Logika Sembunyikan Scrollbar saat diam
function initScrollbarHiding() {
    ...
    window.addEventListener('scroll', () => {
        ...
        }, 1500); // Sembunyikan scrollbar setelah 1.5 detik tidak aktif
    });
}
